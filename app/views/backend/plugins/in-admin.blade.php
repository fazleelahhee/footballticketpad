...
@section('style')
<style>
    #wrap { position:relative; left:0; width:100%; top:0; height:100%; }
...
<div class="row">
    ...
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
        <h1 class="page-title txt-color-blueDark"><!-- PAGE HEADER --><i class="fa-fw fa fa-pencil-square-o"></i> File Manager </h1>
    </div>
    <!-- end col -->
        ...
        <article class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
            ...
            <div class="jarviswidget jarviswidget-sortable" id="wid-id-0" data-widget-togglebutton="false"
                ...
                <header role="heading">
                    ...
                    <h2 class="hidden-xs hidden-sm">File Manager </h2>
                ...
                <div role="content">
                    ...
                    <div class="widget-body">
                        <div id="wrap">
                            <iframe src="/filemanager/show" frameborder="0" id="iframe"></iframe>
                        </div>
                    </div>
