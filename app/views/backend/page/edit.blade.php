...
<div class="row">
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
        <h1 class="page-title txt-color-blueDark"><!-- PAGE HEADER --><i class="fa-fw fa fa-pencil-square-o"></i> Page <span>> Edit Page </span></h1>
    </div>
</div>
                    ...
                    <div id="myTabContent" class="tab-content">
                        ...
                        <div class="tab-pane fade active in" id="s1">
                            ...
                            <div class="control-group {{ $errors->has('parent_id') ? 'has-error' : '' }}">
                                ...
                                <div class="controls">
                                    {{ Form::select('parent_id', $pages , $page->parent_id, array('class'=>'form-control', 'id'=>'parent_id')) }}
                            ...
                            <div class="control-group {{ $errors->has('slug') ? 'has-error' : '' }}">
                                ...
                                <div class="controls">
                                    <div class="input-group">
                                        ...
                                        {{ Form::text('slug', $page->slug, array('class'=>'form-control slug', 'id' => 'slug', 'placeholder'=>'Slug', 'value'=>Input::old('slug'))) }}
                                    </div>
                            ...
                            <div class="control-group {{ $errors->has('content') ? 'has-error' : '' }}">
                                ...
                                <div class="controls">
                                    {{ Form::textarea('content', $page->content, array('class'=>'form-control', 'id' => 'content_page', 'placeholder'=>'Content', 'value'=>Input::old('content'))) }}
                            ...
                            <div class="control-group {{ $errors->has('publication_date') ? 'has-error' : '' }}">
                                ...
                                <div class="controls">
                                    {{ Form::text('publication_date', $page->publication_date, array('data-format'=>"dd/MM/yyyy hh:mm", 'class'=>'form-control ', 'id' => 'publication-date', 'placeholder'=>'Publication Date', 'value'=>Input::old('publication_date'))) }}
                        ...
                        <div class="tab-pane fade tab-hide" id="s2">
                            ...
                            <div class="control-group {{ $errors->has('meta_title') ? 'has-error' : '' }}">
                                ...
                                <div class="controls">
                                    {{ Form::text('meta_title', $page->meta_title, array('class'=>'form-control', 'id' => 'meta-title', 'placeholder'=>'Meta Title', 'value'=>Input::old('meta_title'))) }}
                            ...
                            <div class="control-group {{ $errors->has('meta_keyword') ? 'has-error' : '' }}">
                                ...
                                <div class="controls">
                                    {{ Form::textarea('meta_keyword', $page->meta_keyword, array('class'=>'form-control', 'id' => 'meta-keyword', 'placeholder'=>'Meta Keyword', 'value'=>Input::old('meta_keyword'))) }}
                            ...
                            <div class="control-group {{ $errors->has('meta_description') ? 'has-error' : '' }}">
                                ...
                                <div class="controls">
                                    {{ Form::textarea('meta_description', $page->meta_description, array('class'=>'form-control', 'id' => 'meta-description', 'placeholder'=>'Meta Description', 'value'=>Input::old('meta_descriptiont'))) }}
                        ...
                        <div class="tab-pane fade" id="s4">
                            <div class="control-group {{ $errors->has('feature_image') ? 'has-error' : '' }}">
                                ...
                                <div class="controls feature-image-container">
                                    ...
                                    @if ($feature_image != '' )
                                    <img class="feature-img-preview" src="{{$feature_image}}" style="max-width:300px; max-height:200px;" />
                                    <hr class='image-preview-div' style='margin-top: 10px;' />
                                    @endif
                                    <input name="feature_image" value="{{$feature_image}}" type="hidden" id="feature_image"/>
    ...
    (function ($, f) {
        ...
        f.setImage= function(p,w,h) {
            ...
            if(p) {
                ...
                if(imageUrl) {
                    $('.feature-img-preview').remove();
                    $('.image-preview-div').remove();
