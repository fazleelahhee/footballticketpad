;(function ($) {
    $.fn.slug = function (options) {
        ...
        var makeSlug = function () {
            ...
            if(settings.parent !== undefined && $(settings.parent).html() !== settings.parent_default) {

                $('input.' + settings.slug).val($(settings.parent).html()+'/'+finishedslug.toLowerCase());
                $('span.' + settings.slug).text($(settings.parent).html()+'/'+finishedslug.toLowerCase());
            } else {
